#!/usr/bin/env python3
"""
Simple summary job for crescent-city intelligence system.
"""
...
def get_system_status():
    ...
    try:
        ...
        # Check if gov meeting monitor exists
        if os.path.exists('src/gov_meeting_monitor.ts'):
            status_lines.append("✅ Gov meeting monitoring script exists")
        else:
            status_lines.append("❌ Gov meeting monitoring script missing")
